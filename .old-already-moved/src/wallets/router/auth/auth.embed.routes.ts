...
import { EmbeddedConnectAuthRequestView } from "~routes/_embedded/auth-request/connect/connect.view";
import { EmbeddedSignDataAuthRequestView } from "~routes/_embedded/auth-request/sign/signDataItem.view";
import { EmbeddedDecryptAuthRequestView } from "~routes/_embedded/auth-request/decrypt/decrypt.view";
import { EmbeddedSignatureAuthRequestView } from "~routes/_embedded/auth-request/signature/signature.view";
import { EmbeddedSignAuthRequestView } from "~routes/_embedded/auth-request/sign/sign.view";
import { EmbeddedBatchSignDataItemAuthRequestView } from "~routes/_embedded/auth-request/sign/batchSignDataItem.view";
import { EmbeddedConnectSettingsAuthRequestView } from "~routes/_embedded/auth-request/connect/connect-settings.view";
import { EmbeddedConnectCustomAuthRequestView } from "~routes/_embedded/auth-request/connect/connect-custom.view";
import { EmbeddedSignDetailsAuthRequestView } from "~routes/_embedded/auth-request/sign/sign-details.view";
