...
// Support Views:
import { UnpartitionedStateMissingEmbeddedView } from "~routes/_embedded/support/unpartitioned-state/unpartitioned-state.view";

// Authentication Views:
import { AuthEmbeddedView } from "~routes/_embedded/auth/auth/auth.view";
import { AuthEmailOtpEmbeddedView } from "~routes/_embedded/auth/auth-email-otp/auth-email-otp.view";
import { AuthEmailSignInPasswordEmbeddedView } from "~routes/_embedded/auth/auth-email-sign-in-password/auth-email-sign-in-password.view";
import { AuthEmailVerifyEmbeddedView } from "~routes/_embedded/auth/auth-email-verify/auth-email-verify.view";
import { AuthMoreProvidersEmbeddedView } from "~routes/_embedded/auth/auth-more-providers/auth-more-providers.view";
import { AuthAddWalletEmbeddedView } from "~routes/_embedded/auth/add-wallet/auth-add-wallet.view";
import { AuthImportSeedphraseEmbeddedView } from "~routes/_embedded/auth/import-seedphrase/auth-import-seedphrase.view";
import { AuthImportKeyfileEmbeddedView } from "~routes/_embedded/auth/import-keyfile/auth-import-keyfile.view";
import { AuthImportQrCodeEmbeddedView } from "~routes/_embedded/auth/import-qrcode/auth-import-qrcode";

// Authentication Linking Views:
import { AuthAddDeviceEmbeddedView } from "~routes/_embedded/auth/add-device/auth-add-device.view";
import { AuthAddAuthProviderEmbeddedView } from "~routes/_embedded/auth/add-auth-provider/auth-add-auth-provider.view";

// Shares Views:
import { AuthRestoreSharesEmbeddedView } from "~routes/_embedded/auth/restore-shares/auth-restore-shares.view";
import { AuthRestoreSharesCreateConfirmationEmbeddedView } from "~routes/_embedded/auth/restore-shares/create-confirmation/auth-restore-shares-create-confirmation.view";
import { AuthRestoreSharesRecoveryFileEmbeddedView } from "~routes/_embedded/auth/restore-shares/recovery-file/auth-restore-shares-recovery-file.view";
import { AuthRestoreSharesSeedPhraseEmbeddedView } from "~routes/_embedded/auth/restore-shares/seedphrase/auth-restore-shares-seedphrase.view";
...
import { AuthRestoreSharesQrCodeEmbeddedView } from "~routes/_embedded/auth/restore-shares/qrcode/auth-restore-shares-qrcode.view";

// Account Recovery Views:
import { AuthRecoverAccountEmbeddedView } from "~routes/_embedded/auth/recover-account/auth-recover-account.view";
import { AuthRecoverAccountOtpEmbeddedView } from "~routes/_embedded/auth/recover-account/otp/auth-recover-account-otp.view";
import { AuthRecoverAccountSeedphraseEmbeddedView } from "~routes/_embedded/auth/recover-account/seedphrase/auth-recover-account-seedphrase.view";
import { AuthRecoverAccountKeyfileEmbeddedView } from "~routes/_embedded/auth/recover-account/keyfile/auth-recover-account-keyfile.view";
import { AuthRecoverAccountQrCodeEmbeddedView } from "~routes/_embedded/auth/recover-account/qrcode/auth-recover-account-qrcode.view";
import { AuthRecoverAccountSelectEmbeddedView } from "~routes/_embedded/auth/recover-account/select-account/auth-recover-account-select.view";
import { AuthRecoverAccountConfirmEmbeddedView } from "~routes/_embedded/auth/recover-account/confirm/auth-recover-confirm.view";

// Account Management Views:
import { AccountChangePasswordEmbeddedView } from "~routes/_embedded/account/change-password/account-change-password.view";

// Account Wallet Views:
import { AccountAddWalletEmbeddedView } from "~routes/_embedded/account/add-wallet/account-add-wallet.view";
import { AccountImportSeedphraseEmbeddedView } from "~routes/_embedded/account/import-seedphrase/account-import-seedphrase.view";
import { AccountImportKeyfileEmbeddedView } from "~routes/_embedded/account/import-keyfile/account-import-keyfile.view";

// Account Backup Views:
import { AccountBackupWalletEmbeddedView } from "~routes/_embedded/account/backup-wallet/backup-wallet.view";
import { AccountBackupCopySeedphraseEmbeddedView } from "~routes/_embedded/account/backup-wallet/backup-wallet-copy-seedphrase.view";
import { AccountBackupFullWalletEmbeddedView } from "~routes/_embedded/account/backup-wallet/backup-full-wallet.view";
import { AccountBackupWalletRecoveryFileEmbeddedView } from "~routes/_embedded/account/backup-wallet/backup-wallet-recovery-file.view";
import { AccountBackupWalletQrCodeEmbeddedView } from "~routes/_embedded/account/backup-wallet/backup-wallet-qrcode";
import { AccountExportWalletEmbeddedView } from "~routes/_embedded/account/export-wallet/account-export-wallet.view";

// Wallet Views:
import { WalletHomeEmbeddedView } from "~routes/_embedded/wallet/home/wallet.view";
import { WalletReceiveEmbeddedView } from "~routes/_embedded/wallet/receive/receive.view";
import { WalletTransactionsEmbeddedView } from "~routes/_embedded/wallet/transactions/transactions.view";
import { WalletTransactionsHistoryEmbeddedView } from "~routes/_embedded/wallet/transactions-history/transactions-history.view";
import { WalletTransactionCompleteEmbeddedView } from "~routes/_embedded/wallet/transactions/transaction-complete.view";
import { WalletBuyEmbeddedView } from "~routes/_embedded/wallet/buy/buy.container.view";
import { WalletBuyCashEmbeddedView } from "~routes/_embedded/wallet/buy/buy.cash.view";
import { WalletReceiveOptionsEmbeddedView } from "~routes/_embedded/wallet/receive/options/receive.options.view";
import { WalletDepositTokensEmbeddedView } from "~routes/_embedded/wallet/deposit/deposit.container.view";
import { WalletBuyInputEmbeddedView } from "~routes/_embedded/wallet/buy/buy.input.view";
import { WalletBuySuccessEmbeddedView } from "~routes/_embedded/wallet/buy/buy.success.view";
