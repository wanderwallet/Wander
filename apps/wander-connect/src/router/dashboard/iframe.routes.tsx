import { CONNECT_AUTH_ROUTES } from "../auth/auth.routes";
import { RouteConfig, isRouteOverride, getExtensionOverrides } from "@wanderapp/core";

// Support Views:
import { UnpartitionedStateMissingEmbeddedView } from "../../views/support/unpartitioned-state/unpartitioned-state.view";

// Authentication Views:
import { AuthEmbeddedView } from "../../views/auth/auth/auth.view";
import { AuthEmailOtpEmbeddedView } from "../../views/auth/auth-email-otp/auth-email-otp.view";
import { AuthEmailSignInPasswordEmbeddedView } from "../../views/auth/auth-email-sign-in-password/auth-email-sign-in-password.view";
import { AuthEmailVerifyEmbeddedView } from "../../views/auth/auth-email-verify/auth-email-verify.view";
import { AuthMoreProvidersEmbeddedView } from "../../views/auth/auth-more-providers/auth-more-providers.view";
import { AuthAddWalletEmbeddedView } from "../../views/auth/add-wallet/auth-add-wallet.view";
import { AuthImportSeedphraseEmbeddedView } from "../../views/auth/import-seedphrase/auth-import-seedphrase.view";
import { AuthImportKeyfileEmbeddedView } from "../../views/auth/import-keyfile/auth-import-keyfile.view";
import { AuthImportQrCodeEmbeddedView } from "../../views/auth/import-qrcode/auth-import-qrcode";

// Authentication Linking Views:
import { AuthAddDeviceEmbeddedView } from "../../views/auth/add-device/auth-add-device.view";
import { AuthAddAuthProviderEmbeddedView } from "../../views/auth/add-auth-provider/auth-add-auth-provider.view";

// Shares Views:
import { AuthRestoreSharesEmbeddedView } from "../../views/auth/restore-shares/auth-restore-shares.view";
import { AuthRestoreSharesCreateConfirmationEmbeddedView } from "../../views/auth/restore-shares/create-confirmation/auth-restore-shares-create-confirmation.view";
import { AuthRestoreSharesRecoveryFileEmbeddedView } from "../../views/auth/restore-shares/recovery-file/auth-restore-shares-recovery-file.view";
import { AuthRestoreSharesSeedPhraseEmbeddedView } from "../../views/auth/restore-shares/seedphrase/auth-restore-shares-seedphrase.view";
import { AuthRestoreSharesKeyfileEmbeddedView } from "../../views/auth/restore-shares/keyfile/auth-restore-shares-keyfile.view";
import { AuthRestoreSharesQrCodeEmbeddedView } from "../../views/auth/restore-shares/qrcode/auth-restore-shares-qrcode.view";

// Account Recovery Views:
import { AuthRecoverAccountEmbeddedView } from "../../views/auth/recover-account/auth-recover-account.view";
import { AuthRecoverAccountOtpEmbeddedView } from "../../views/auth/recover-account/otp/auth-recover-account-otp.view";
import { AuthRecoverAccountSeedphraseEmbeddedView } from "../../views/auth/recover-account/seedphrase/auth-recover-account-seedphrase.view";
import { AuthRecoverAccountKeyfileEmbeddedView } from "../../views/auth/recover-account/keyfile/auth-recover-account-keyfile.view";
import { AuthRecoverAccountQrCodeEmbeddedView } from "../../views/auth/recover-account/qrcode/auth-recover-account-qrcode.view";
import { AuthRecoverAccountSelectEmbeddedView } from "../../views/auth/recover-account/select-account/auth-recover-account-select.view";
import { AuthRecoverAccountConfirmEmbeddedView } from "../../views/auth/recover-account/confirm/auth-recover-confirm.view";

// Account Management Views:
import { AccountChangePasswordEmbeddedView } from "../../views/account/change-password/account-change-password.view";

// Account Wallet Views:
import { AccountAddWalletEmbeddedView } from "../../views/account/add-wallet/account-add-wallet.view";
import { AccountImportSeedphraseEmbeddedView } from "../../views/account/import-seedphrase/account-import-seedphrase.view";
import { AccountImportKeyfileEmbeddedView } from "../../views/account/import-keyfile/account-import-keyfile.view";

// Account Backup Views:
import { AccountBackupWalletEmbeddedView } from "../../views/account/backup-wallet/backup-wallet.view";
import { AccountBackupCopySeedphraseEmbeddedView } from "../../views/account/backup-wallet/backup-wallet-copy-seedphrase.view";
import { AccountBackupFullWalletEmbeddedView } from "../../views/account/backup-wallet/backup-full-wallet.view";
import { AccountBackupWalletRecoveryFileEmbeddedView } from "../../views/account/backup-wallet/backup-wallet-recovery-file.view";
import { AccountBackupWalletQrCodeEmbeddedView } from "../../views/account/backup-wallet/backup-wallet-qrcode";
import { AccountExportWalletEmbeddedView } from "../../views/account/export-wallet/account-export-wallet.view";

// Wallet Views:
import { WalletHomeEmbeddedView } from "../../views/wallet/home/wallet.view";
import { WalletReceiveEmbeddedView } from "../../views/wallet/receive/receive.view";
import { WalletTransactionsEmbeddedView } from "../../views/wallet/transactions/transactions.view";
import { WalletTransactionsHistoryEmbeddedView } from "../../views/wallet/transactions-history/transactions-history.view";
import { WalletTransactionCompleteEmbeddedView } from "../../views/wallet/transactions/transaction-complete.view";
import { WalletBuyEmbeddedView } from "../../views/wallet/buy/buy.container.view";
import { WalletBuyCashEmbeddedView } from "../../views/wallet/buy/buy.cash.view";
import { WalletReceiveOptionsEmbeddedView } from "../../views/wallet/receive/options/receive.options.view";
import { WalletDepositTokensEmbeddedView } from "../../views/wallet/deposit/deposit.container.view";
import { WalletBuyInputEmbeddedView } from "../../views/wallet/buy/buy.input.view";
import { WalletBuySuccessEmbeddedView } from "../../views/wallet/buy/buy.success.view";
