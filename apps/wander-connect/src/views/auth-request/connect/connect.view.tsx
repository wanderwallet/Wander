...
import { concatGatewayURL, ExtensionStorage, formatAddress, FULL_HISTORY, setActiveWallet, useActiveWallet, useAllWallets, useCurrentAuthRequest, useGateway, useLocation, useNameServiceProfile } from "@wanderapp/core";
import { Button, Text, Row, Box, Avatar, WalletIcon, AuthRequestCard } from "@wanderapp/ui";
import { Wallet } from "../../../utils/embedded.types";
