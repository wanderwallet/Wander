...
import { browserInfo, useLocation } from "@wanderapp/core";
import { Image, FormattedText, OnboardingCard, Button, Checkbox, Snackbar } from "@wanderapp/ui";
...
import { COULD_NOT_ACCESS_UNPARTITIONED_STATE_ERR_MESSAGE } from "../../../utils/storage/unpartitioned-storage/unpartitioned-storage";
import { HAS_ADVANCED_STORAGE_API } from "../../../utils/storage/unpartitioned-storage/unpartitioned-storage.utils";
