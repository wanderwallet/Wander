...
export default function Tutorial() {
  ...
  const [arLocalCommandStatus, setArLocalCommandStatus] = useState<InputStatus>("default");
  ...
  return (
    <>
      ...
      <InputWithBtn>
        <InputWrapper>
          <Input type="text" fullWidth readOnly defaultValue="npx arlocal" status={arLocalCommandStatus} />
        </InputWrapper>
        <IconButton
          variant="secondary"
          onClick={() => {
