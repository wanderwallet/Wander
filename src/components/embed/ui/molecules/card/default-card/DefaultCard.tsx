...
export interface DefaultCardProps extends Omit<CardBaseProps, "footerElement" | "size" | "customIcon" | "onCloseButtonClick" | "closeButtonStyles"> {
  hasFooter?: boolean;
}
...
export function DefaultCard({
  ...
  return (
    <Card
      {...cardProps}
      footerElement={hasFooter ? <WanderFooter /> : null }
      size="auto"
      children={ children } />
  )
}
