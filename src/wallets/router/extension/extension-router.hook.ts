...
import type { WanderRoutePath, BaseLocationHook } from "~wallets/router/router.types";

const WALLET_STATUS_TO_OVERRIDE: Record<WalletStatus, ExtensionRouteOverride | null> = {
