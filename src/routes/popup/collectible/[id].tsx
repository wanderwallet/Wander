...
export function CollectibleView({ params: { id } }: CollectibleViewProps) {
  ...
  async function getCollectionDescription() {
    ...
    try {
      ...
      const description = getTagValue("Description", data.transaction.tags as any[]);
  ...
  return (
    <>
      ...
      <Thumbnail src={`${concatGatewayURL(defaultGateway)}/${id}`} fallback={placeholderUrl} />
      <Section>
        ...
        <Spacer y={1} />
        <Description>
          {(!loading && <>{description || browser.i18n.getMessage("no_description")}</>) ||
            new Array(5)
              .fill("")
              .map((_, i) => <Skeleton addMargin height="1rem" width={i === 4 ? "80%" : "100%"} key={i} />)}
        </Description>
        <Spacer y={1} />
        <Title size="lg" weight="medium" noMargin>
        ...
        {(!loading && (
          ...
          new Array(4).fill("").map((_, i) => <Skeleton addMargin height="1rem" width="6.8rem" key={i} />)}
      </Section>
  ...
  <svg width="1900" height="1900" viewBox="0 0 1900 1900" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <clipPath id="clip0_1849_336">
        <rect width="1478" height="1293" fill="white" transform="translate(211 303)" />
      </clipPath>
    </defs>
  </svg>
);
    ...
    <g transform="matrix(1, 0, 0, -1, -26, 126)">
      <g transform="scale(0.1)">
        <path
          ...
          fill="#ffffff"></path>
        <path d="M 452.117,942.512 760,764.758 1067.87,942.512 760,1120.27 452.117,942.512" fill="#81d6f7"></path>
        <path d="M 1075.33,929.602 767.449,751.848 V 396.34 l 307.881,177.742 v 355.52" fill="#316bbd"></path>
        <path d="M 444.668,574.082 752.539,396.34 V 751.848 L 444.668,929.602 v -355.52" fill="#469fde"></path>
        <path
...
const AoLinkIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="7" viewBox="0 0 32 7" fill="none">
    <g clip-path="url(#clip0_428_9057)">
      <path d="M0 6.28965H1.93604L2.33115 5.22119L1.44215 3.40088L0 6.28965Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M13.4895 5.47895H15.9561V6.05403H12.8486V0.720703H13.4895V5.47895Z" fill="#9EA2AA" />
      <path
