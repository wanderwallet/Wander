...
export function AuthEmailVerifyEmbeddedView() {
  ...
  return (
    ...
    >
      <Box style={{ gap: 32 }}>
        <Text
          style={{ color: "var(--text-color-primary, #121212)" }}
          variant={"bodyLg"}
          alignment={"center"}
        >
        ...
        <Flex direction="column" gap={24} width="100%">
          ...
          >
            Click on the link in that email to complete your sign up. If you do
            not see it, you may need to check your spam folder.
          </Text>
          <Flex direction="column" gap={4} width="100%">
            <Text
              variant={"bodyXs"}
              alignment={"center"}
              style={{ color: "var(--text-color-tertiary, #838383)" }}
            >
