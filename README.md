...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/hoNtgjU3kv)
...
```sh
npx nx serve wander-connect
```

To create a production bundle:

```sh
npx nx build wander-connect
```

To see all available targets to run for a project, run:

```sh
npx nx show project wander-connect
```
