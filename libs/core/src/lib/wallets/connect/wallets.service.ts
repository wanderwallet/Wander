...
import type { Wallet, WalletActivationStatus } from "~utils/_embedded/embedded.types";
import { trpcVanilla } from "~utils/_embedded/embedded.utils";
import { isTRPCClientError } from "~utils/_embedded/utils/trpc/trpc.utils";
